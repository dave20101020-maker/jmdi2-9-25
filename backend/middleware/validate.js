...
export const pillarSchemas = {
  create: z.object({
    pillar: z.enum(['sleep', 'diet', 'exercise', 'physical_health', 'mental_health', 'finances', 'social', 'spirituality']),
...
export const entrySchemas = {
  ...
  query: z.object({
    pillar: z.enum(['sleep', 'diet', 'exercise', 'physical_health', 'mental_health', 'finances', 'social', 'spirituality']).optional(),
...
export const habitSchemas = {
  create: z.object({
    ...
    customDays: z.array(z.number().min(0).max(6)).max(7, 'Invalid days array').optional(),
...
export const aiSchemas = {
  coachRequest: z.object({
    ...
    pillarId: z.enum(['sleep', 'diet', 'exercise', 'physical_health', 'mental_health', 'finances', 'social', 'spirituality']).optional(),
  ...
  insightsParam: z.object({
    pillarId: z.enum(['sleep', 'diet', 'exercise', 'physical_health', 'mental_health', 'finances', 'social', 'spirituality']),
  }),
};
...
export const challengeSchemas = {
  create: z.object({
    ...
    pillar: z.enum(['sleep', 'diet', 'exercise', 'physical_health', 'mental_health', 'finances', 'social', 'spirituality']),
    duration: z.number().min(1, 'Duration must be at least 1 day').max(365, 'Duration too long'),
...
export const subscriptionSchemas = {
  create: z.object({
    tier: z.enum(['free', 'basic', 'premium', 'nhs_referred']),
