...
const suggestedHabits = {
  sleep: [
    ...
    },
    {
      ...
      description: 'Stop using phones, tablets, and computers 1 hour before sleep',
      relevance: 8,
      difficulty: 6,
      impact: 7,
      feasibility: 7,
  ...
  mental_health: [
    ...
    },
    {
      ...
      description: 'Journal for 10 minutes daily about your thoughts and feelings',
      relevance: 8,
      difficulty: 2,
      impact: 8,
      feasibility: 9,
    ...
    },
    {
      ...
      description: 'Schedule 30 minutes of quality time with friends/family daily',
      relevance: 8,
      difficulty: 5,
      impact: 8,
      feasibility: 7,
  ...
  social: [
    ...
    {
      name: 'Outreach Calls',
      description: 'Call or video chat with 2 friends you haven\'t talked to recently',
      relevance: 7,
      difficulty: 3,
      impact: 7,
      feasibility: 8,
    ...
    weakPillars.forEach((pillarScore) => {
      ...
      pillarSuggestions.forEach((suggestion) => {
        ...
        allSuggestions.push({
          ...
          reason: `Your ${pillarScore.pillar} score is ${pillarScore.score.toFixed(1)}/10. This habit can help improve it.`,
        });
      });
    });
  ...
  try {
    ...
    const response = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: 'system',
          content: 'You are a wellness coach creating personalized habit suggestions. Always return valid JSON.',
        },
        {
          role: 'user',
          content: prompt,
