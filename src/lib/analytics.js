...
export const analytics = {
  ...
  // AI Interactions
  aiInteractionStarted: (pillar) => trackEvent('ai_interaction_started', { pillar }),
  aiInteractionCompleted: (pillar, duration) => trackEvent('ai_interaction_completed', { pillar, duration }),
  aiInteractionError: (pillar, error) => trackEvent('ai_interaction_error', { pillar, error }),
  ...
  // Check-ins
  checkinCreated: (pillar, score) => trackEvent('checkin_created', { pillar, score }),
  journalEntry: (pillar) => trackEvent('journal_entry', { pillar }),

  // Content
  contentGenerated: (type, pillar) => trackEvent('content_generated', { type, pillar }),
  ...
  contentFlagged: (contentId, reason) => trackEvent('content_flagged', { contentId, reason }),
