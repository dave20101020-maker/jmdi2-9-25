...
import { Target, Plus, TrendingUp, CheckCircle2, Filter, Sparkles } from "lucide-react";
    ...
    return (
      <div className="min-h-screen flex items-center justify-center pb-20">
        <div className="text-center">
          ...
          <p className="text-white/60">Loading your goals...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen pb-24 px-6 pt-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-8">
          <div className="w-20 h-20 mx-auto mb-4 rounded-full bg-gradient-to-br from-[#D4AF37] to-[#F4D03F] flex items-center justify-center"
            style={{ boxShadow: '0 0 30px rgba(212, 175, 55, 0.5)' }}
          >
            <Target className="w-10 h-10 text-[#0A1628]" />
          </div>
          <h1 className="text-3xl md:text-4xl font-bold text-white mb-2">SMART Goals</h1>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          ...
          <div className="bg-[#1a1f35] border border-white/20 rounded-xl p-4">
            ...
            <div className="text-3xl font-bold text-[#4CC9F0]">{activeGoals.length}</div>
          </div>
          
          <div className="bg-[#1a1f35] border border-white/20 rounded-xl p-4">
            <div className="text-white/70 text-sm mb-1">Completed</div>
            <div className="text-3xl font-bold text-green-400">{completedGoals.length}</div>
          </div>
        ...
        <div className="mt-8 bg-blue-500/10 border border-blue-500/30 rounded-2xl p-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="text-lg font-bold text-white mb-2">What are SMART Goals?</h3>
              <ul className="text-white/80 text-sm space-y-1">
                <li><strong>Specific:</strong> Clear and well-defined</li>
                <li><strong>Measurable:</strong> Track your progress with numbers</li>
                <li><strong>Achievable:</strong> Realistic and attainable</li>
                <li><strong>Relevant:</strong> Aligned with your values and needs</li>
                <li><strong>Time-bound:</strong> Has a deadline or timeframe</li>
              </ul>
              <p className="text-white/70 text-sm mt-3">
                💡 Our AI helps transform your ideas into actionable SMART goals with personalized recommendations!
              </p>
            </div>
          </div>
        </div>
