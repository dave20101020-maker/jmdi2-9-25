...
import { ChevronLeft, Send, CheckCircle2, Bug, Lightbulb, MessageSquare, HelpCircle, Heart, AlertCircle, Loader2 } from "lucide-react";
...
const FEEDBACK_TYPES = [
  ...
  { id: 'feature', label: 'Feature Request', icon: Lightbulb, color: '#F59E0B', description: 'Suggest a new feature' },
  { id: 'feedback', label: 'General Feedback', icon: MessageSquare, color: '#3B82F6', description: 'Share your thoughts' },
  { id: 'question', label: 'Question', icon: HelpCircle, color: '#8B5CF6', description: 'Ask us anything' },
  { id: 'love', label: 'Appreciation', icon: Heart, color: '#EC4899', description: 'Share what you love!' }
];
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.error('Failed to send feedback', {
        description: 'Please try again or email us directly at support@northstar.app',
        duration: 7000,
        action: {
          label: 'Copy Email',
          onClick: () => {
    ...
    <div className="min-h-screen pb-24 px-6 pt-8">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-white mb-2">Feedback & Support</h1>
          <p className="text-white/70">
            We'd love to hear from you! Your feedback helps us make NorthStar better.
          </p>
        </div>
        ...
        <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 mb-6">
          ...
          <div className="mb-6">
            <div className="flex items-center justify-between mb-2">
              ...
              <span className={`text-xs ${message.length > 2000 ? 'text-red-400' : 'text-white/60'}`}>
                {message.length}/2000
              </span>
            </div>
            <Textarea
            ...
            <p className="text-white/60 text-xs mt-2">
              💡 Be as detailed as possible. Screenshots or examples are always helpful!
            </p>
          </div>
        ...
        <div className="bg-gradient-to-br from-blue-500/10 to-purple-600/10 border border-blue-500/30 rounded-2xl p-6">
          ...
          <div className="space-y-3 text-sm">
            <div className="p-3 bg-white/5 rounded-lg">
              <div className="text-white font-medium mb-1">Need immediate help?</div>
              <div className="text-white/70">
                ...
                <button 
                  onClick={() => {
                    navigate(createPageUrl("Profile"));
                    setTimeout(() => {
                      const replayButton = document.querySelector('[aria-label*="Replay"]');
            ...
            <div className="p-3 bg-white/5 rounded-lg">
              ...
              <div className="text-white/70">
                Please describe what you were doing when it happened and what you expected to happen
              </div>
            </div>
            
            <div className="p-3 bg-white/5 rounded-lg">
              <div className="text-white font-medium mb-1">Contact us directly</div>
