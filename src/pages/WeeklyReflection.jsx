...
import { Calendar, CheckCircle2, Lightbulb, TrendingUp, Star, ArrowRight } from "lucide-react";
...
export default function WeeklyReflection() {
  ...
  const weekStart = format(startOfWeek(lastSunday, { weekStartsOn: 1 }), 'yyyy-MM-dd');
  const weekEnd = format(endOfWeek(lastSunday, { weekStartsOn: 1 }), 'yyyy-MM-dd');
  ...
  const plansNeedingReview = activePlans.filter(p => !existingReviewPlanIds.includes(p.id));
    ...
    <div className="min-h-screen px-6 py-12">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-white mb-2">Weekly Reflection</h1>
        ...
        >
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h2 className="text-2xl font-bold text-white mb-1">{currentPlan.planTitle}</h2>
              <span 
        ...
        <div className="flex gap-3">
          ...
          >
            {saveMutation.isPending ? 'Saving...' : currentPlanIndex < plansNeedingReview.length - 1 ? 'Next Plan' : 'Complete'}
          </Button>
        </div>
      </div>
    </div>
