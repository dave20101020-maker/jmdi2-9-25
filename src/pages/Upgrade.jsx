...
const PREMIUM_FEATURES = [
  {
    ...
    desc: "Talk to your AI coaches anytime, unlimited messages",
  },
  {
    icon: "📊",
    title: "Advanced Analytics",
    desc: "Correlation insights, predictive trends, custom date ranges",
  },
  {
    icon: "📥",
    title: "Data Export",
    desc: "Download your data in CSV, PDF, or JSON anytime",
  },
  {
    icon: "🎯",
    title: "Multiple Goals",
    desc: "Track up to 10 active goals simultaneously",
  },
  {
    icon: "🧊",
    title: "Streak Freezes",
    desc: "3 freeze days per month to protect your streak",
  },
  {
    icon: "🎨",
    title: "Custom Themes",
    desc: "Dark Galaxy, Ocean Depths, Forest Zen, and more",
  },
  {
    icon: "⚡",
    title: "Priority AI Response",
    desc: "Faster, more detailed coach responses",
  },
  { icon: "🚫", title: "Ad-Free", desc: "Clean, distraction-free experience" },
  {
    icon: "🔔",
    title: "Weekly PDF Reports",
    desc: "Comprehensive progress summaries",
  },
  {
    icon: "👑",
    title: "Premium Badge",
    desc: "Show your commitment on leaderboards",
  },
];
    ...
    return (
      <div className="min-h-screen pb-24 px-6 pt-8">
        <div className="max-w-2xl mx-auto text-center">
          <div
            className="w-24 h-24 mx-auto mb-6 rounded-full bg-gradient-to-br from-[#D4AF37] to-[#F4D03F] flex items-center justify-center"
          ...
          <p className="text-white/70 mb-8 text-base">
            Enjoying the full NorthStar experience with all premium features
            unlocked.
          </p>
  ...
  if (isTrial) {
    ...
    return (
      <div className="min-h-screen pb-24 px-6 pt-8">
        <div className="max-w-2xl mx-auto text-center">
          <div
            className="w-24 h-24 mx-auto mb-6 rounded-full bg-gradient-to-br from-green-400 to-emerald-500 flex items-center justify-center animate-pulse"
          ...
          <div className="bg-gradient-to-r from-[#D4AF37]/20 to-[#F4D03F]/20 border border-[#D4AF37]/40 rounded-2xl p-6 mb-6">
            ...
            <p className="text-white/80 mb-4 text-base">
              Don't lose access to unlimited AI coaching, advanced analytics,
            ...
            <p className="text-sm text-white/60 mb-4">
              Payment details will be added when trial ends. Cancel anytime
              before then.
            </p>
    ...
    <div className="min-h-screen pb-24 px-6 pt-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          {/* Monthly Plan */}
          <div
            className={`bg-white/5 border rounded-2xl p-8 transition-all ${
          ...
          <div
            className="bg-gradient-to-br from-[#D4AF37]/20 to-[#F4D03F]/20 border-2 border-[#D4AF37] rounded-2xl p-8 relative"
          ...
          >
            ...
            <div className="text-center mb-6">
              ...
              <div className="text-[#D4AF37] text-base font-bold">
                Only $6.67/month
              </div>
        ...
        <div className="bg-gradient-to-r from-blue-500/20 to-purple-500/20 border border-blue-500/40 rounded-2xl p-8 mb-12 text-center">
          ...
          <p className="text-white/80 mb-6 text-base">
            "NorthStar Premium transformed my daily routine. The AI coaching is
            like having a personal wellness team!"
          </p>
