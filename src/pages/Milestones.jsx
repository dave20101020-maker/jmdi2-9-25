...
import { ArrowLeft, Trophy, Medal, Award, Target, Filter, Calendar, TrendingUp, Star, Sparkles, Crown, Flame } from "lucide-react";
...
export default function Milestones() {
  ...
  const { data: milestones = [], isLoading } = useQuery({
    ...
    queryFn: () => api.getMilestones({ userId: user?.email }, '-created_date', 200),
    enabled: !!user,
    initialData: []
  });
    ...
    return (
      <div className="min-h-screen flex items-center justify-center pb-20">
        <div className="text-center">
          ...
          <p className="text-white/60">Loading milestones...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-white/60 text-sm">Your achievements and progress</p>
          </div>
        </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-8 md:p-12 max-w-lg mx-auto">
              ...
              <div className="w-32 h-32 md:w-40 md:h-40 mx-auto mb-6" aria-hidden="true">
                <svg viewBox="0 0 200 200" className="w-full h-full">
                  {/* Podium */}
                  <rect x="130" y="100" width="40" height="70" fill="#CD7F32" opacity="0.3" rx="4" />
                  <text x="150" y="180" textAnchor="middle" fill="#CD7F32" fontSize="24" fontWeight="bold">3</text>
                  
                  <rect x="30" y="80" width="40" height="90" fill="#C0C0C0" opacity="0.3" rx="4" />
                  <text x="50" y="180" textAnchor="middle" fill="#C0C0C0" fontSize="24" fontWeight="bold">2</text>
                  
                  <rect x="80" y="50" width="40" height="120" fill="#FFD700" opacity="0.3" rx="4" />
                  <text x="100" y="180" textAnchor="middle" fill="#FFD700" fontSize="24" fontWeight="bold">1</text>
                  
                  {/* Trophy on top */}
                  <text x="100" y="35" textAnchor="middle" fontSize="30">🏆</text>
                  
                  {/* Stars */}
                  <text x="40" y="40" fontSize="16" opacity="0.5">⭐</text>
                  <text x="160" y="60" fontSize="16" opacity="0.5">⭐</text>
                  <text x="70" y="25" fontSize="12" opacity="0.4">✨</text>
                  <text x="140" y="35" fontSize="12" opacity="0.4">✨</text>
                </svg>
              </div>
              
              <h2 className="text-2xl md:text-3xl font-bold text-white mb-3">Start Earning Milestones</h2>
              ...
              <div className="bg-gradient-to-br from-purple-500/10 to-blue-600/10 border border-purple-500/30 rounded-xl p-4 md:p-6 text-left">
                ...
                <ul className="space-y-2 text-xs md:text-sm text-white/80">
                  <li className="flex items-start gap-2">
                    ...
                    <span><strong>Build Streaks:</strong> Track pillars or complete habits for 3, 7, 21, 30 days straight</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Star className="w-4 h-4 text-yellow-400 flex-shrink-0 mt-0.5" />
                    <span><strong>Score High:</strong> Achieve scores above 80 on individual pillars</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Target className="w-4 h-4 text-green-400 flex-shrink-0 mt-0.5" />
                    <span><strong>Complete Plans:</strong> Finish life plans and reach 100% on goals</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Crown className="w-4 h-4 text-[#D4AF37] flex-shrink-0 mt-0.5" />
                    <span><strong>Life Score:</strong> Maintain high overall scores across all pillars</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 mb-6">
              ...
              >
                ...
                <div className="text-2xl md:text-3xl font-bold text-[#D4AF37]">{milestones.length}</div>
              ...
              <div className="bg-[#1a1f35] border border-white/20 rounded-xl p-3 md:p-4">
                ...
                <div className="text-2xl md:text-3xl font-bold text-[#F4D03F]">{totalPoints}</div>
              ...
              <div className="bg-[#1a1f35] border border-white/20 rounded-xl p-3 md:p-4">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <div className="text-white/70 text-xs md:text-sm">Streaks</div>
                </div>
                <div className="text-2xl md:text-3xl font-bold text-orange-400">{byType.streak || 0}</div>
              ...
              <div className="bg-[#1a1f35] border border-white/20 rounded-xl p-3 md:p-4">
                ...
                <div className="text-2xl md:text-3xl font-bold text-green-400">{byType.plan_completion || 0}</div>
            ...
            <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-4 mb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4">
                <div>
                  <Label className="text-white/80 mb-2 block text-sm">Type</Label>
                ...
                <div>
                  <Label className="text-white/80 mb-2 block text-sm">Pillar</Label>
                ...
                <div>
                  <Label className="text-white/80 mb-2 block text-sm">Sort By</Label>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between gap-3 mt-4 pt-4 border-t border-white/10">
                <p className="text-white/60 text-sm">
                  Showing {sortedMilestones.length} of {milestones.length} milestones
                </p>
            ...
            {sortedMilestones.length === 0 ? (
              <div className="text-center py-12 md:py-16">
                <div className="bg-white/5 border border-white/10 rounded-2xl p-8 md:p-12 max-w-md mx-auto">
                  ...
                  <h2 className="text-xl md:text-2xl font-bold text-white mb-2">No Matches Found</h2>
            ...
            {milestones.length > 0 && ( // This card shows if there are ANY milestones, regardless of current filter match
              <div className="mt-8 bg-blue-500/10 border border-blue-500/30 rounded-2xl p-4 md:p-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="text-base md:text-lg font-bold text-white mb-2">How to Earn Milestones</h3>
                    <ul className="space-y-2 text-xs md:text-sm text-white/80">
                      <li className="flex items-start gap-2">
                        <span className="text-blue-400 flex-shrink-0">•</span>
                        <span><strong>Streak Milestones:</strong> Complete habits or track pillars consecutively (3, 7, 21, 30 days)</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-blue-400 flex-shrink-0">•</span>
                        <span><strong>Score Milestones:</strong> Achieve high scores on individual pillars (&gt;80)</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-blue-400 flex-shrink-0">•</span>
                        <span><strong>Plan Completion:</strong> Successfully complete life plans and goals</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-blue-400 flex-shrink-0">•</span>
                        <span><strong>Life Score:</strong> Maintain high overall life scores across all pillars</span>
                      </li>
                    </ul>
                  </div>
                </div>
