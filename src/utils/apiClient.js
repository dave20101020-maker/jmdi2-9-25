...
class APIClient {
  ...
  async upgradeSubscription(tier) {
    return this.request('/subscription/upgrade', { method: 'POST', body: JSON.stringify({ tier }) });
  }

  // Pillar check-ins
  async createPillarCheckIn(data) {
    return this.request('/pillars/check-in', { method: 'POST', body: JSON.stringify(data) });
  }
  ...
  async sendFriendRequest(data) {
    return this.request('/friends/request', { method: 'POST', body: JSON.stringify(data) });
  }

  async acceptFriendRequest(data) {
    return this.request('/friends/accept', { method: 'POST', body: JSON.stringify(data) });
  }
  ...
  async createChallenge(data) {
    return this.request('/challenges', { method: 'POST', body: JSON.stringify(data) });
  }

  async joinChallenge(challengeId) {
    return this.request('/challenges/join', { method: 'POST', body: JSON.stringify({ challengeId }) });
  }
  ...
  async sendMessage(data) {
    return this.request('/messages/send', { method: 'POST', body: JSON.stringify(data) });
  }
  ...
  async markNotificationsRead(body) {
    return this.request('/notifications/mark-read', { method: 'POST', body: JSON.stringify(body) });
  }
