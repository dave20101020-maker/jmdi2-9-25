 ...
 * ═══════════════════════════════════════════════════════════════════════════
 *
 * OneSignal integration with smart scheduling and notification UI
 */
...
export class PushNotificationManager {
  ...
  static scheduleNotification(title, options = {}) {
    ...
    if (repeat) {
      ...
      return setInterval(() => this.sendNotification(title, options), delay);
    } else {
      // Schedule one-time notification
      return setTimeout(() => this.sendNotification(title, options), delay);
    }
  }
      ...
      <div className="space-y-2">
        <label className="flex items-center gap-3">
          <input
            ...
            onChange={(e) =>
              handleScheduleChange("habitReminders", e.target.checked)
            }
          />
        ...
        {schedule.habitReminders && (
          <input
            ...
            onChange={(e) =>
              handleScheduleChange("habitReminderTime", e.target.value)
            }
      ...
      <div className="space-y-2">
        <label className="flex items-center gap-3">
          <input
            ...
            onChange={(e) =>
              handleScheduleChange("dailyCheckIn", e.target.checked)
            }
          />
        ...
        {schedule.dailyCheckIn && (
          <input
            ...
            onChange={(e) =>
              handleScheduleChange("dailyCheckInTime", e.target.value)
            }
            className="ml-6 px-3 py-2 border border-gray-300 rounded-lg"
          />
        )}
      ...
      <div className="space-y-2">
        <label className="flex items-center gap-3">
          <input
            ...
            onChange={(e) =>
              handleScheduleChange("weeklyReport", e.target.checked)
            }
          />
        ...
        {schedule.weeklyReport && (
          <div className="ml-6 flex gap-2">
            <select
              ...
              onChange={(e) =>
                handleScheduleChange("weeklyReportDay", e.target.value)
              }
            ...
            <input
              ...
              onChange={(e) =>
                handleScheduleChange("weeklyReportTime", e.target.value)
              }
              className="px-3 py-2 border border-gray-300 rounded-lg"
            />
          </div>
      ...
      <div className="space-y-2">
        <label className="flex items-center gap-3">
          <input
            ...
            onChange={(e) =>
              handleScheduleChange("friendUpdates", e.target.checked)
            }
          />
        ...
        <label className="flex items-center gap-3">
          <input
            ...
            onChange={(e) =>
              handleScheduleChange("achievementNotifications", e.target.checked)
            }
          />
        ...
        <label className="flex items-center gap-3">
          <input
            ...
            onChange={(e) =>
              handleScheduleChange("leaderboardUpdates", e.target.checked)
            }
          />
