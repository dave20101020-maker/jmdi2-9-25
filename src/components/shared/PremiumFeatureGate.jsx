...
export default function PremiumFeatureGate({ 
  ...
  return (
    <div className="bg-gradient-to-br from-[#D4AF37]/10 to-[#F4D03F]/10 border-2 border-[#D4AF37]/40 rounded-2xl p-8 text-center"
      style={{ boxShadow: '0 0 30px rgba(212, 175, 55, 0.2)' }}
    >
      <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-br from-[#D4AF37] to-[#F4D03F] flex items-center justify-center"
